...
// On Render: store DB on persistent disk (/var/data). Locally: store next to this file.
const DB_PATH = process.env.DB_PATH || path.join(__dirname, 'rental_database.db');
