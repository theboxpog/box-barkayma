...
console.log('\n=== ADDING OVERDUE STATUS TO RESERVATIONS ===\n');
...
db.serialize(() => {
  ...
  `, (err) => {
    ...
    db.run(`DROP TABLE IF EXISTS reservations`, (err) => {
      ...
      console.log('3. Creating new reservations table with overdue status...');
      db.run(`
        CREATE TABLE reservations (
          ...
          status TEXT DEFAULT 'active' CHECK(status IN ('active', 'cancelled', 'completed', 'delivered', 'returned', 'overdue')),
